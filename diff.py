...
trn_ds = RxRxDataset(
    trn_df, ROOT,
    crop=224, resize=sz, hat=(128, 128), norm=True, sigma_clip=5.0, label_smoothing=0.1)

val_ds = RxRxDataset(
    val_df, ROOT,
    crop=224, resize=sz, hat=(128, 128), norm=True, sigma_clip=5.0, label_smoothing=None)
...
opt = Ranger(params=[
    ...
    {'params': model.base.features.denseblock2.parameters(), 'lr': base_lr // 10  },
    {'params': model.base.features.denseblock1.parameters(), 'lr': base_lr // 100 }
])
...
loaders = create_loaders(batch_size=20, drop_last=True)
...
checkpoint = Checkpoint('densenet169_224')
